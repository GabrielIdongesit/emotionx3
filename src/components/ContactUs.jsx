...
const ContactUs = () => {
  return (
    <div className='py-[3rem] pt-[6rem] bg-heroimage'>
            <div className='grid grid-cols lg:grid-cols-2 container gap-x-6 mx-auto'>
                        ...
                        <div>
                            <div className="flex items-center ">
                                ...
                                <div>
                                    ...
                                    <div className='text-gray-500 font-semibold text-[10px] '>+234 8126412836</div>
                                </div>
                            </div>
                        </div>
                        <div className="flex items-center ">
                ...
                {/* <div > */}
                <img className='shadow-2xl mt-2 lg:mt-[-40px] p-2' src={Image} alt='' />
                {/* </div> */}
            </div>
